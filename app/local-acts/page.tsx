    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Нажмите, чтобы перейти на официальный сайт и ознакомиться с локальными актами
              </p>
        ...
        <div className="mt-8 rounded-lg border border-blue-100 bg-blue-50 p-4 text-sm text-blue-800">
          <p className="font-medium">📌 Локальные акты</p>
          <p className="mt-1 text-blue-600">
            Все локальные акты публикуются на официальном сайте детского сада. Нажмите на карточку выше, чтобы перейти к полному перечню.
          </p>
        </div>
      </div>
    </div>
