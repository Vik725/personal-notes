...
const GOSUSLUGI_URL = "https://vsad25.gosuslugi.ru/svedeniya-ob-obrazovatelnoy-organizatsii/struktura-i-organy-upravleniya-obrazovatelnoy-organizatsii/upravlyayuschiy-sovet/lokalnye-akty/";

const localActs = [
  { title: "Положение о режиме занятий воспитанников", description: "Режим работы и расписание занятий" },
  { title: "Правила внутреннего распорядка", description: "Правила поведения для воспитанников и сотрудников" },
  { title: "Положение о родительском комитете", description: "Порядок работы родительского комитета" },
];
      ...
      <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        <div className="mx-auto max-w-4xl px-4 py-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold sm:text-3xl">Локальные акты</h1>
              <p className="mt-1 text-sm text-blue-200">
                Акты, принятые с учётом мнения Управляющего совета
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">
                Локальные акты на сайте детского сада
              </h2>
              <p className="mt-1 text-sm text-gray-500">
                Нажмите, чтобы перейти на официальный сайт и посмотреть актуальные локальные акты
              </p>
        ...
        <div className="mt-8 rounded-lg border border-blue-100 bg-blue-50 p-4 text-sm text-blue-800">
          ...
          <p className="mt-1 text-blue-600">
            Полный перечень локальных актов публикуется на официальном сайте детского сада.
          </p>
        </div>
      </div>
    </div>
